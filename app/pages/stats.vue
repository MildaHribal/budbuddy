    ...
    <div class="content-wrapper">
      ...
      >
        ...
        <div class="strains-list">
          ...
          >
            ...
            <div
              class="strain-rating"
              :style="{ color: getStageColor(p.stage) }"
            >
              <Icon
                :icon="getStageIcon(p.stage)"
                :height="16"
              />
              <span>{{ p.stage }}</span>
            </div>
      ...
      >
        ...
        <div class="trends-list">
          <div
            class="trend-item"
            :class="totalWaterings > 0 ? 'positive' : 'neutral'"
          >
            <Icon
              icon="tabler:droplet-filled"
              :height="24"
          ...
          <div
            class="trend-item"
            :class="totalFeedings > 0 ? 'positive' : 'neutral'"
          >
            <Icon
              icon="tabler:flask"
              :height="24"
          ...
          <div
            class="trend-item"
            :class="totalPhotos > 0 ? 'positive' : 'neutral'"
          >
            <Icon
              icon="tabler:camera"
              :height="24"
...
import { usePlantJournal, type JournalEntry } from '~/composables/usePlantJournal'
...
const allJournalEntries = ref<JournalEntry[]>([])
...
const totalDaysGrowing = computed(() => {
  return plants.value.reduce((acc, p) => {
